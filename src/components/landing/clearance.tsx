...
export default function Clearance() {
  return (
    <div className="bg-[#C1D7CB] p-12 pt-8">
      <div>
        {" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:px-0 mt-8 gap-8 m-4">
        {clearanceContent.map((item) => (
          <div className="" key={item.id}>
            <div className="flex items-center h-[300px] justify-center rounded-md bg-black m-4 text-white gap-6">
              <div className="mx-6">
                <h6>{item.text}</h6>
